# ⚔️ Portal de Documentação do Minecraft 26.3
...
Bem-vindo ao portal técnico de documentação do **Instant Gratification: Combat Cooldown Adjuster** no **Minecraft 26.3** (alvo `26.3-snapshot-6`)! Todas as informações refletem o código real desta versão.
...
| :--- | :--- | :--- |
| **Mecânicas de Tempo de Recarga de Armas** | Delay overrides, item tags, attack rate math, hotbar swap agility | [[26.3 Mecânicas de Tempo de Recarga de Armas|pt_br-26.3-Weapon-Cooldown-Mechanics]] |
| **Impacto de Combate e Retorno de Áudio** | Dynamic pitch shifting ($1.0\times - 1.4\times$), critical particle bursts | [[26.3 Impacto de Combate e Retorno de Áudio|pt_br-26.3-Combat-Juice-and-Audio-Feedback]] |
| **Configuração e Matriz de GameRules** | Complete reference matrix of all 9 namespaced GameRules | [[26.3 Configuração e Matriz de GameRules|pt_br-26.3-Configuration-and-GameRules]] |
| **Arquitetura e Análise de Mixins** | Bytecode injection analysis, `PlayerMixin`, `CCAHooks` design | [[26.3 Arquitetura e Análise de Mixins|pt_br-26.3-Architecture-and-Mixins]] |
| **Ambiente de Desenvolvimento e Toolchain** | JDK 25 environment, Gradle 9.3+ build commands, Loom setup | [[26.3 Ambiente de Desenvolvimento e Toolchain|pt_br-26.3-Developer-Setup-and-Building]] |
...
* [[Portal de Documentação do Minecraft 26.2|pt_br-26.2-Home]]
