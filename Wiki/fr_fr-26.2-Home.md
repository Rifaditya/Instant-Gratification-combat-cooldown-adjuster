# ⚔️ Portail de Documentation Minecraft 26.2
...
Bienvenue sur le portail de documentation technique de **Instant Gratification: Combat Cooldown Adjuster** pour **Minecraft 26.2** (cible `26.1.2`) ! Tous les guides correspondent fidèlement à cette version.
...
| :--- | :--- | :--- |
| **Mécaniques de Temps de Recharge des Armes** | Delay overrides, item tags, attack rate math, hotbar swap agility | [[26.2 Mécaniques de Temps de Recharge des Armes|fr_fr-26.2-Weapon-Cooldown-Mechanics]] |
| **Impact Visuel et Retour Audio en Combat** | Dynamic pitch shifting ($1.0\times - 1.4\times$), critical particle bursts | [[26.2 Impact Visuel et Retour Audio en Combat|fr_fr-26.2-Combat-Juice-and-Audio-Feedback]] |
| **Configuration et Matrice des GameRules** | Complete reference matrix of all 9 namespaced GameRules | [[26.2 Configuration et Matrice des GameRules|fr_fr-26.2-Configuration-and-GameRules]] |
| **Architecture et Analyse des Mixins** | Bytecode injection analysis, `PlayerMixin`, `CCAHooks` design | [[26.2 Architecture et Analyse des Mixins|fr_fr-26.2-Architecture-and-Mixins]] |
| **Environnement Développeur & Outils** | JDK 25 environment, Gradle 9.3+ build commands, Loom setup | [[26.2 Environnement Développeur & Outils|fr_fr-26.2-Developer-Setup-and-Building]] |
...
* [[Portail de Documentation Minecraft 26.3|fr_fr-26.3-Home]]
