...
## 3. 玩家主权与反说教原则 (Anti-Nanny Invariant)
本模组严格恪守 **Player Agency & Anti-Nanny Invariant**：
* **不设人为上限**：Tick 延迟允许设置至 `Integer.MAX_VALUE` ($2,147,483,647$)，玩家享有完全自由。
* **非负下界守卫**：强制下界 $T \ge 0$，杜绝除零或负数引发的游戏引擎崩溃。
