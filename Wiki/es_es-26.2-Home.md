# ⚔️ Portal de Documentación Minecraft 26.2
...
¡Bienvenido al portal técnico de **Instant Gratification: Combat Cooldown Adjuster** para **Minecraft 26.2** (objetivo `26.1.2`)! Toda la documentación refleja con exactitud el código y configuración de esta versión.
...
| :--- | :--- | :--- |
| **Mecánicas de Enfriamiento de Armas** | Delay overrides, item tags, attack rate math, hotbar swap agility | [[26.2 Mecánicas de Enfriamiento de Armas|es_es-26.2-Weapon-Cooldown-Mechanics]] |
| **Retroalimentación de Combate y Efectos de Audio** | Dynamic pitch shifting ($1.0\times - 1.4\times$), critical particle bursts | [[26.2 Retroalimentación de Combate y Efectos de Audio|es_es-26.2-Combat-Juice-and-Audio-Feedback]] |
| **Configuración y Matriz de GameRules** | Complete reference matrix of all 9 namespaced GameRules | [[26.2 Configuración y Matriz de GameRules|es_es-26.2-Configuration-and-GameRules]] |
| **Arquitectura y Análisis de Mixins** | Bytecode injection analysis, `PlayerMixin`, `CCAHooks` design | [[26.2 Arquitectura y Análisis de Mixins|es_es-26.2-Architecture-and-Mixins]] |
| **Entorno de Desarrollo y Herramientas** | JDK 25 environment, Gradle 9.3+ build commands, Loom setup | [[26.2 Entorno de Desarrollo y Herramientas|es_es-26.2-Developer-Setup-and-Building]] |
...
* [[Portal de Documentación Minecraft 26.3|es_es-26.3-Home]]
