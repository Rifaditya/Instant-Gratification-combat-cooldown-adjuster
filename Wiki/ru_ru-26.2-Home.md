# ⚔️ Портал документации Minecraft 26.2
...
Добро пожаловать на технический портал документации **Instant Gratification: Combat Cooldown Adjuster** для **Minecraft 26.2** (цель `26.1.2`)! Все материалы соответствуют кодовой базе данного релиза.

---

## 🧭 Матрица навигации по разделам Minecraft 26.2

| Функция / Подсистема | Описание | Страница документации |
| :--- | :--- | :--- |
| **Механика перезарядки оружия** | Delay overrides, item tags, attack rate math, hotbar swap agility | [[26.2 Механика перезарядки оружия|ru_ru-26.2-Weapon-Cooldown-Mechanics]] |
| **Динамика ударов и аудио-отклик** | Dynamic pitch shifting ($1.0\times - 1.4\times$), critical particle bursts | [[26.2 Динамика ударов и аудио-отклик|ru_ru-26.2-Combat-Juice-and-Audio-Feedback]] |
| **Конфигурация и игровые правила** | Complete reference matrix of all 9 namespaced GameRules | [[26.2 Конфигурация и игровые правила|ru_ru-26.2-Configuration-and-GameRules]] |
| **Архитектура и миксины** | Bytecode injection analysis, `PlayerMixin`, `CCAHooks` design | [[26.2 Архитектура и миксины|ru_ru-26.2-Architecture-and-Mixins]] |
| **Среда разработчика и сборка** | JDK 25 environment, Gradle 9.3+ build commands, Loom setup | [[26.2 Среда разработчика и сборка|ru_ru-26.2-Developer-Setup-and-Building]] |
...
* [[Портал документации Minecraft 26.3|ru_ru-26.3-Home]]
