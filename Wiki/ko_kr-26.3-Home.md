...
**Minecraft 26.3**(대상 `26.3-snapshot-6`)용 **Instant Gratification: Combat Cooldown Adjuster** 기술 문서 포털에 오신 것을 환영합니다! 이 버전 트리의 모든 문서는 해당 릴리스의 바이트코드 매핑 및 기능 사양을 정확히 반영합니다.
...
| :--- | :--- | :--- |
| **무기 쿨다운 메커니즘** | Delay overrides, item tags, attack rate math, hotbar swap agility | [[26.3 무기 쿨다운 메커니즘|ko_kr-26.3-Weapon-Cooldown-Mechanics]] |
| **전투 타격감 및 오디오 피드백** | Dynamic pitch shifting ($1.0\times - 1.4\times$), critical particle bursts | [[26.3 전투 타격감 및 오디오 피드백|ko_kr-26.3-Combat-Juice-and-Audio-Feedback]] |
| **구성 및 게임 규칙(GameRules) 매트릭스** | Complete reference matrix of all 9 namespaced GameRules | [[26.3 구성 및 게임 규칙(GameRules) 매트릭스|ko_kr-26.3-Configuration-and-GameRules]] |
| **아키텍처 및 믹스인(Mixins) 분석** | Bytecode injection analysis, `PlayerMixin`, `CCAHooks` design | [[26.3 아키텍처 및 믹스인(Mixins) 분석|ko_kr-26.3-Architecture-and-Mixins]] |
| **개발자 설정 및 툴체인** | JDK 25 environment, Gradle 9.3+ build commands, Loom setup | [[26.3 개발자 설정 및 툴체인|ko_kr-26.3-Developer-Setup-and-Building]] |
...
* [[Minecraft 26.2 문서 포털|ko_kr-26.2-Home]]
