...
欢迎访问 **Instant Gratification: Combat Cooldown Adjuster** 在 **Minecraft 26.2**（目标 `26.1.2`）的技术文档门户！本版本树内所有技术文档严格匹配当前版本的字节码映射、Loom 依赖项与功能规范。

---

## 🧭 Minecraft 26.2 子系统导航矩阵

| 功能 / 子系统 | 详细描述 | 专属维基页面 |
| :--- | :--- | :--- |
| **武器冷却机制** | Delay overrides, item tags, attack rate math, hotbar swap agility | [[26.2 武器冷却机制|zh_cn-26.2-Weapon-Cooldown-Mechanics]] |
| **战斗打击感与音效反馈** | Dynamic pitch shifting ($1.0\times - 1.4\times$), critical particle bursts | [[26.2 战斗打击感与音效反馈|zh_cn-26.2-Combat-Juice-and-Audio-Feedback]] |
| **配置与游戏规则矩阵** | Complete reference matrix of all 9 namespaced GameRules | [[26.2 配置与游戏规则矩阵|zh_cn-26.2-Configuration-and-GameRules]] |
| **架构设计与 Mixin 解析** | Bytecode injection analysis, `PlayerMixin`, `CCAHooks` design | [[26.2 架构设计与 Mixin 解析|zh_cn-26.2-Architecture-and-Mixins]] |
| **开发者配置与构建** | JDK 25 environment, Gradle 9.3+ build commands, Loom setup | [[26.2 开发者配置与构建|zh_cn-26.2-Developer-Setup-and-Building]] |
...
## 🔗 全局维基传送门
* [[返回主维基门户|zh_cn-Home]]
* [[Minecraft 26.3 文档门户|zh_cn-26.3-Home]]
