# ⚔️ Portal Dokumentasi Minecraft 26.3
...
Selamat datang di portal dokumentasi teknis resmi untuk **Instant Gratification: Combat Cooldown Adjuster** di **Minecraft 26.3** (menargetkan `26.3-snapshot-6`). Semua dokumentasi mencerminkan spesifikasi bytecode dan dependensi Loom untuk rilis ini.

---

## 🧭 Matriks Navigasi untuk Minecraft 26.3

| Fitur / Subsistem | Deskripsi Lengkap | Halaman Wiki Khusus |
| :--- | :--- | :--- |
| **Mekanika Cooldown Senjata** | Delay overrides, item tags, attack rate math, hotbar swap agility | [[26.3 Mekanika Cooldown Senjata|id_id-26.3-Weapon-Cooldown-Mechanics]] |
| **Umpan Balik Tempur & Efek Audio Visual** | Dynamic pitch shifting ($1.0\times - 1.4\times$), critical particle bursts | [[26.3 Umpan Balik Tempur & Efek Audio Visual|id_id-26.3-Combat-Juice-and-Audio-Feedback]] |
| **Konfigurasi & Matriks GameRules** | Complete reference matrix of all 9 namespaced GameRules | [[26.3 Konfigurasi & Matriks GameRules|id_id-26.3-Configuration-and-GameRules]] |
| **Arsitektur & Analisis Mixin** | Bytecode injection analysis, `PlayerMixin`, `CCAHooks` design | [[26.3 Arsitektur & Analisis Mixin|id_id-26.3-Architecture-and-Mixins]] |
| **Pengaturan Pengembang & Toolchain** | JDK 25 environment, Gradle 9.3+ build commands, Loom setup | [[26.3 Pengaturan Pengembang & Toolchain|id_id-26.3-Developer-Setup-and-Building]] |
...
* [[Portal Dokumentasi Minecraft 26.2|id_id-26.2-Home]]
