...
## 3. 玩家主權與反說教原則 (Anti-Nanny Invariant)
本模組嚴格恪守 **Player Agency & Anti-Nanny Invariant**：
* **不設人為上限**：Tick 延遲允許設定至 `Integer.MAX_VALUE` ($2,147,483,647$)，玩家享有完全自由。
* **非負下界守衛**：強制下界 $T \ge 0$，杜絕除零或負數引發的遊戲引擎當機。
